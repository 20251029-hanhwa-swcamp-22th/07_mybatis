...
public class MybatisConfig {
    ...
    public HikariDataSource dataSource() {
        ...
        /* 풀에서 동시에 유지 가능한 최대 커넥션 개수 */
        dataSource.setMaximumPoolSize(50);

        /* 사용하지 않는 커넥션 유휴 시간 */
        dataSource.setIdleTimeout(600000); // 600초

        /* 커넥션의 최대 생명 주기 설정 (오래된 커넥션을 주기적을 교체) */
        dataSource.setMaximumPoolSize(180000);// 300분
...
/*
        configuration.getTypeAliasRegistry().registerAlias("com.ohgiraffers");
*/
    ...
    // SqlSessionTemplate : SqlSession + openSession() + close() -> 위기능을 안적어도 자동으로
    @Bean
