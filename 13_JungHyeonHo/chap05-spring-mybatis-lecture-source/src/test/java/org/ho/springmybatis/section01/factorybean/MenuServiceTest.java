package org.ho.springmybatis.section01.factorybean;
...
class MenuServiceTest {
  ...
  public void setUp() {
    // getMapper할때 대신 menuMapper return
    Mockito.when(sqlSession.getMapper(MenuMapper.class))
  ...
  void findAllMenuByOrderableStatus_Y() {
    ...
    MenuDTO menu1 = new MenuDTO(1, "김치찌개", 8000, 1, orderableStatus);
    MenuDTO menu2 = new MenuDTO(2, "된장찌개", 8500, 1, orderableStatus);
