package org.ho.transaction.service;

import lombok.AllArgsConstructor;
import org.ho.transaction.domain.Order;
import org.ho.transaction.domain.OrderMenu;
import org.ho.transaction.dto.OrderDTO;
import org.ho.transaction.dto.OrderMenuDTO;
import org.ho.transaction.mapper.OrderMapper;
...
public class OrderService {
  ...
  public void registerOrder(OrderDTO orderDTO, List<OrderMenuDTO> orderMenuDTOs) {
    ...
    if (1 == 1) throw new RuntimeException(); // 오류가 생기면 if(1==1)로 컴파일러를 속일 수 있다
