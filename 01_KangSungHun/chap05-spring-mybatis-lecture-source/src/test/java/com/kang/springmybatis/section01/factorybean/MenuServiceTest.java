...
*   MenuService의 순수비즈니스 로직을 검증
*
* - Mockito : 가짜 객체(Mock)를 만들어서
*   해당 객체가 어떤 상황에서 어떤 값을 반환할지 정의할 수 있게 하는 테스트 프레임워크
* */
...
class MenuServiceTest {
    ...
    @Mock
    private MenuMapper menuMapper; // Mybatis 가 Mapper를 실제 구현하지 않아도 메서드 호출 가능

    @InjectMocks // 모의 객체를 MenuService에 집어넣음 (DI 대체)
